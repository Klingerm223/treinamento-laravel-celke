...
return [
    ...
    | de tamanho. Sinta-se à vontade para ajustar cada uma dessas mensagens aqui.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para trocar nossos marcadores de atributo
